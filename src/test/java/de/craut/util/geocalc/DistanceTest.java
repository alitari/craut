...
public class DistanceTest {
	...
	public void testDistance() {
		...
		Point kew = new Point(lat.getValue(), lng.getValue());

		// Richmond
		lat = new DegreeCoordinate(51.4613418);
		lng = new DegreeCoordinate(-0.3035466);
		Point richmond = new Point(lat.getValue(), lng.getValue());
	...
	public void testDistanceBnaToLax() {
		...
		Point BNA = new Point(lat.getValue(), lng.getValue());

		lat = new DegreeCoordinate(33.94);
		lng = new DegreeCoordinate(-118.40);
		Point LAX = new Point(lat.getValue(), lng.getValue());
	...
	public void testDistanceToBuenosAires() {
		...
		Point buenosAires = new Point(lat.getValue(), lng.getValue());
	...
	public void testBoundingAreaDistance() {
		...
		Point middleNorth = new Point(new DegreeCoordinate(area.getNorthEast().getX()).getValue(), new DegreeCoordinate((area.getSouthWest().getY() + area
		        .getNorthEast().getY()) / 2).getValue());
		...
		Point middleSouth = new Point(new DegreeCoordinate(area.getSouthWest().getX()).getValue(), new DegreeCoordinate((area.getSouthWest().getY() + area
		        .getNorthEast().getY()) / 2).getValue());
		...
		Point middleWest = new Point(new DegreeCoordinate((area.getNorthEast().getX() + area.getSouthWest().getX()) / 2).getValue(), new DegreeCoordinate(area
		        .getNorthEast().getY()).getValue());
		...
		Point middleEast = new Point(new DegreeCoordinate((area.getNorthEast().getX() + area.getSouthWest().getX()) / 2).getValue(), new DegreeCoordinate(area
		        .getSouthWest().getY()).getValue());
	...
	public void testBoundingAreaNorthPole() {
		...
		Point northPole = new Point(lat.getValue(), lng.getValue());
	...
	public void testPointRadialDistanceZero() {
		...
		assertEquals(lat.getValue(), sameKew.getX(), 1E-10);
		assertEquals(lng.getValue(), sameKew.getY(), 1E-10);
	...
	public void testPointRadialDistance() {
		...
		assertEquals(richmond.getX(), allegedRichmond.getX(), 10E-5);
		assertEquals(richmond.getY(), allegedRichmond.getY(), 10E-5);
